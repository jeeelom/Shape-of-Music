...
//--------------ROW ROW ROW LEVEL 1 --------
	    ...
	    get3RandomShapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,'mi','re');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,questionSound,soundMi2,soundRe2);
...
//--------------ROW ROW ROW LEVEL 5 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,'re','re');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,questionSound,soundRe2,soundRe3);
...
//--------------ROW ROW ROW LEVEL 6 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,'mi','mi','mi');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,questionSound,soundMi2,soundMi3,soundMiPat);
...
//--------------ROW ROW ROW LEVEL 7 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,'mi','re','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,questionSound,soundMi2,soundRe2,soundLdo2);
...
//--------------ROW ROW ROW LEVEL 8 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,'re','mi','mi');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,questionSound,soundRe2,soundMi2,soundMi3);
...
//--------------ROW ROW ROW LEVEL 9 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,'mi','Ldo','re');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,questionSound,soundMi2,soundLdo2,soundRe2);
...
//--------------ROW ROW ROW LEVEL 10 --------
	//--- RANDOM SOUNDS
	    ...
	    get8RandomShapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
	    	row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,'re','re','mi','re','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame8Shapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
			row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,questionSound,soundRe2,soundRe3,soundMi2,soundRePat,soundLdo2);
			...
			{	
				...
				{													
					...
					if ( $('#'+$level+'1').text() == $soundPattern1 && $('#'+$level+'2').text() == $soundPattern2) 
					{
						...
						if (level_check >= nl)
						{
							window.localStorage.setItem("lamb_current_level",++nl);
						}
...
{
	var retries = window.localStorage.getItem("lamb_num_ret");
	...
	window.localStorage.setItem("lamb_num_ret",++retries);

//	alert("Retries = " + window.localStorage.getItem("lamb_num_ret") );
