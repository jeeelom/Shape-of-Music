...
//--------------ROW ROW ROW LEVEL 4 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,'sol','fa');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,questionSound,soundSol2,soundFa2);
...
//--------------ROW ROW ROW LEVEL 5 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,'fa','mi');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,questionSound,soundFa2,soundMi2);
...
//--------------ROW ROW ROW LEVEL 6 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,'mi','mi','re');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,questionSound,soundMi2,soundMi3,soundRe2);
...
//--------------ROW ROW ROW LEVEL 7 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,'Ldo','sol','sol');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,questionSound,soundLdo2,soundSol2,soundSol3);
...
//--------------ROW ROW ROW LEVEL 8 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,'fa','fa','mi');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,questionSound,soundFa2,soundFa3,soundMi2);
...
//--------------ROW ROW ROW LEVEL 9 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,'mi','re','sol');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,questionSound,soundMi2,soundRe2,soundSol2);
...
//--------------ROW ROW ROW LEVEL 10 --------
	//--- RANDOM SOUNDS
	    ...
	    get8RandomShapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
	    	row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,'sol','fa','fa','mi','mi');

	    //-- END RANDOM SHAPES
		
		startGame8Shapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
			row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,questionSound,soundSol2,soundFa2,soundFa3,soundMi2,soundMi3);
			...
			{	
				...
				{													
					...
					if ( $('#'+$level+'1').text() == $soundPattern1 && $('#'+$level+'2').text() == $soundPattern2) 
					{
						...
						if (level_check >= nl)
						{
							window.localStorage.setItem("twinkle_current_level",++nl);
						}
...
{
	var retries = window.localStorage.getItem("twinkle_num_ret");
	...
	window.localStorage.setItem("twinkle_num_ret",++retries);

	alert("Retries = " + window.localStorage.getItem("twinkle_num_ret") );
