...
//--------------ROW ROW ROW LEVEL 1 --------
	    ...
	    get3RandomShapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,'re','re');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,questionSound,soundRe2,soundRe3);
...
//--------------ROW ROW ROW LEVEL 2 --------
	 //--- RANDOM SOUNDS
	  	...
	  	var row_lvl_2_snd3 = soundLa;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get3RandomShapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,'la','la');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,questionSound,soundLa2,soundLa3);
...
//--------------ROW ROW ROW LEVEL 3 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,'si','si');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,questionSound,soundSi2,soundSi3);
...
//--------------ROW ROW ROW LEVEL 4 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,'si','si');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,questionSound,soundSi2,soundSi3);
...
//--------------ROW ROW ROW LEVEL 6 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,'sol','fa','fa');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,questionSound,soundSol2,soundFa2,soundFa3);
...
//--------------ROW ROW ROW LEVEL 7 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,'mi','mi','re');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,questionSound,soundMi2,soundMi3,soundRe2);
...
//--------------ROW ROW ROW LEVEL 8 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,'re','re','re');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,questionSound,soundRe2,soundRe3,soundRePat);
...
//--------------ROW ROW ROW LEVEL 9 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,'la','la','la');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,questionSound,soundLa2,soundLa3,soundLa3);
...
//--------------ROW ROW ROW LEVEL 10 --------
	//--- RANDOM SOUNDS
	    ...
	    get8RandomShapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
	    	row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,'si','si','si','la','la');

	    //-- END RANDOM SHAPES
		
		startGame8Shapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
			row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,questionSound,soundSi2,soundSi3,soundSiPat,soundLa2,soundLa3);
			...
			{	
				...
				{													
					...
					if ( $('#'+$level+'1').text() == $soundPattern1 && $('#'+$level+'2').text() == $soundPattern2) 
					{
						...
						if (level_check >= nl)
						{
							window.localStorage.setItem("blacksheep_current_level",++nl);
						}
...
{
	var retries = window.localStorage.getItem("blacksheep_num_ret");
	...
	window.localStorage.setItem("blacksheep_num_ret",++retries);

	//alert("Retries = " + window.localStorage.getItem("blacksheep_num_ret") );
