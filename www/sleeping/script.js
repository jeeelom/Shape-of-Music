...
//--------------ROW ROW ROW LEVEL 2 --------
	 //--- RANDOM SOUNDS
		...
		startGame3Shapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,questionSound,soundMi2,soundLdo3);
...
//--------------ROW ROW ROW LEVEL 3 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,'Ldo','re');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,questionSound,soundLdo2,soundRe2);
...
//--------------ROW ROW ROW LEVEL 4 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,'mi','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,questionSound,soundMi2,soundLdo2);
...
//--------------ROW ROW ROW LEVEL 7 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,'sol','sol','la');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,questionSound,soundSol2,soundSol3,soundLa2);
...
//--------------ROW ROW ROW LEVEL 8 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,'sol','fa','mi');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,questionSound,soundSol2,soundFa2,soundMi2);
...
//--------------ROW ROW ROW LEVEL 9 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,'Ldo','sol','la');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,questionSound,soundLdo2,soundSol2,soundLa2);
...
//--------------ROW ROW ROW LEVEL 10 --------
	//--- RANDOM SOUNDS
	    ...
	    get8RandomShapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
	    	row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,'sol','fa','mi','Ldo','Hdo');

	    //-- END RANDOM SHAPES
		
		startGame8Shapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
			row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,questionSound,soundSol2,soundFa2,soundMi2,soundLdo2,soundHdo2);
			...
			{	
				...
				{													
					...
					if ( $('#'+$level+'1').text() == $soundPattern1 && $('#'+$level+'2').text() == $soundPattern2) 
					{
						...
						if (level_check >= nl)
						{
							window.localStorage.setItem("sleeping_current_level",++nl);
						}
...
{
	var retries = window.localStorage.getItem("sleeping_num_ret");
	...
	window.localStorage.setItem("sleeping_num_ret",++retries);

//	alert("Retries = " + window.localStorage.getItem("sleeping_num_ret") );
