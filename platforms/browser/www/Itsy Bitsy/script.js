...
//--------------ROW ROW ROW LEVEL 1 --------
	    ...
	    //--- RANDOM SOUNDS
	  	...
	  	var row_lvl_1_snd1 = soundSol;
	  	var row_lvl_1_snd2 = soundRe;
	  	var row_lvl_1_snd3 = soundLdo;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get3RandomShapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,'sol','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,questionSound,soundSol,soundLdo2);
...
//--------------ROW ROW ROW LEVEL 2 --------
	 //--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,'Ldo','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,questionSound,soundLdo2,soundLdo3);
...
//--------------ROW ROW ROW LEVEL 3 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,'re','mi');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,questionSound,soundRe2,soundMi2);
...
//--------------ROW ROW ROW LEVEL 4 --------
	//--- RANDOM SOUNDS
	    ...
	    get3RandomShapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,'mi','mi');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,questionSound,soundMi2,soundMi3);
...
//--------------ROW ROW ROW LEVEL 5 --------
	//--- RANDOM SOUNDS
	  	...
	  	var row_lvl_5_snd1 = soundRe;
	  	var row_lvl_5_snd2 = soundSol;
	  	var row_lvl_5_snd3 = soundLdo;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get3RandomShapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,'re','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,questionSound,soundRe2,soundLdo2);
...
//--------------ROW ROW ROW LEVEL 6 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,'re','mi','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,questionSound,soundRe2,soundMi2,soundLdo2);
...
//--------------ROW ROW ROW LEVEL 7 --------
	//--- RANDOM SOUNDS
		...
		startGame5Shapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,questionSound,soundSol,soundSol2,soundSol3);
...
//--------------ROW ROW ROW LEVEL 8 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,'sol','sol','fa');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,questionSound,soundSol2,soundSol3,soundFa2);
...
//--------------ROW ROW ROW LEVEL 9 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,'mi','fa','sol');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,questionSound,soundMi2,soundFa2,soundSol2);
...
//--------------ROW ROW ROW LEVEL 10 --------
	//--- RANDOM SOUNDS
	    ...
	    get8RandomShapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
	    	row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,'sol','mi','Ldo','sol','sol');

	    //-- END RANDOM SHAPES
		
		startGame8Shapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
			row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,questionSound,soundSol2,soundMi3,soundLdo3,soundSol3,soundSolPat);
			...
			{	
				...
				{													
					...
					if ( $('#'+$level+'1').text() == $soundPattern1 && $('#'+$level+'2').text() == $soundPattern2) 
					{
						...
						if (level_check >= nl)
						{
							window.localStorage.setItem("itsbits_current_level",++nl);
						}
...
{
	var retries = window.localStorage.getItem("itsbits_num_ret");
	...
	window.localStorage.setItem("itsbits_num_ret",++retries);

	//alert("Retries = " + window.localStorage.getItem("itsbits_num_ret") );
