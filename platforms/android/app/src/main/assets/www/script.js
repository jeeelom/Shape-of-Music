  ...
  var stepnum = 1;
	...
	// --- DEFINE SOUNDS ---
		...
		//PIANO
		var piano_soundLdo = document.createElement('audio');
	    piano_soundLdo.setAttribute('src', 'doremi/piano_Ldo.wav');

	    var piano_soundRe = document.createElement('audio');
	    piano_soundRe.setAttribute('src', 'doremi/piano_re.wav');

	    var piano_soundMi = document.createElement('audio');
	    piano_soundMi.setAttribute('src', 'doremi/piano_mi.wav');

	    var piano_soundFa = document.createElement('audio');
	    piano_soundFa.setAttribute('src', 'doremi/piano_fa.wav');

	    var piano_soundSol = document.createElement('audio');
	    piano_soundSol.setAttribute('src', 'doremi/piano_sol.wav');

	    var piano_soundLa = document.createElement('audio');
	    piano_soundLa.setAttribute('src', 'doremi/piano_la.wav');

	    var piano_soundSi = document.createElement('audio');
	    piano_soundSi.setAttribute('src', 'doremi/piano_si.wav');

	    var piano_soundHdo = document.createElement('audio');
	    piano_soundHdo.setAttribute('src', 'doremi/piano_Hdo.wav');
		// END PIANO

		//Guitar
		var guitar_soundLdo = document.createElement('audio');
	    guitar_soundLdo.setAttribute('src', 'audio/Guitar Do.mp3');

	    var guitar_soundRe = document.createElement('audio');
	    guitar_soundRe.setAttribute('src', 'audio/Guitar re.mp3');

	    var guitar_soundMi = document.createElement('audio');
	    guitar_soundMi.setAttribute('src', 'audio/Guitar Mi.mp3');

	    var guitar_soundFa = document.createElement('audio');
	    guitar_soundFa.setAttribute('src', 'audio/Guitar Fa.mp3');

	    var guitar_soundSol = document.createElement('audio');
	    guitar_soundSol.setAttribute('src', 'audio/Guitar Sol.mp3');

	    var guitar_soundLa = document.createElement('audio');
	    guitar_soundLa.setAttribute('src', 'audio/Guitar La.mp3');

	    var guitar_soundSi = document.createElement('audio');
	    guitar_soundSi.setAttribute('src', 'audio/Guitar Si.mp3');

	    var guitar_soundHdo = document.createElement('audio');
	    guitar_soundHdo.setAttribute('src', 'audio/Guitar Hdo.mp3');

		//END Guitar


		//Saxophone
		var sax_soundLdo = document.createElement('audio');
	    sax_soundLdo.setAttribute('src', 'audio/saxo Do.mp3');

	    var sax_soundRe = document.createElement('audio');
	    sax_soundRe.setAttribute('src', 'audio/saxo re.mp3');

	    var sax_soundMi = document.createElement('audio');
	    sax_soundMi.setAttribute('src', 'audio/saxo mi.mp3');

	    var sax_soundFa = document.createElement('audio');
	    sax_soundFa.setAttribute('src', 'audio/saxo fa.mp3');

	    var sax_soundSol = document.createElement('audio');
	    sax_soundSol.setAttribute('src', 'audio/saxo sol.mp3');

	    var sax_soundLa = document.createElement('audio');
	    sax_soundLa.setAttribute('src', 'audio/saxo la.mp3');

	    var sax_soundSi = document.createElement('audio');
	    sax_soundSi.setAttribute('src', 'audio/saxo Ti.mp3');

	    var sax_soundHdo = document.createElement('audio');
	    sax_soundHdo.setAttribute('src', 'audio/saxo Hdo.mp3');
		//END Saxophone


		//violin

		var vio_soundLdo = document.createElement('audio');
	    vio_soundLdo.setAttribute('src', 'audio/violin Do.mp3');

	    var vio_soundRe = document.createElement('audio');
	    vio_soundRe.setAttribute('src', 'audio/violin re.mp3');

	    var vio_soundMi = document.createElement('audio');
	    vio_soundMi.setAttribute('src', 'audio/violin mi.mp3');

	    var vio_soundFa = document.createElement('audio');
	    vio_soundFa.setAttribute('src', 'audio/violin fa.mp3');

	    var vio_soundSol = document.createElement('audio');
	    vio_soundSol.setAttribute('src', 'audio/violin sol.mp3');

	    var vio_soundLa = document.createElement('audio');
	    vio_soundLa.setAttribute('src', 'audio/violin la.mp3');

	    var vio_soundSi = document.createElement('audio');
	    vio_soundSi.setAttribute('src', 'audio/violin ti.mp3');

	    var vio_soundHdo = document.createElement('audio');
	    vio_soundHdo.setAttribute('src', 'audio/violin Hdo.mp3');
		//END violin


		var p_firstSND , p_secondSND , p_thirdSND , p_fourthSND , p_fifthSND , p_sixthSND , p_seventhSND , p_eightSND;

		p_firstSND = piano_soundLdo;
		p_secondSND = piano_soundRe;
		p_thirdSND = piano_soundMi;
		p_fourthSND = piano_soundFa;
		p_fifthSND = piano_soundSol;
		p_sixthSND = piano_soundLa;
		p_seventhSND = piano_soundSi;
		p_eightSND = piano_soundHdo;
...
//--------------ROW ROW ROW LEVEL 1 --------
	    ...
	    //--- RANDOM SOUNDS
	  	...
	  	var row_lvl_1_snd1 = soundLdo;
	  	var row_lvl_1_snd2 = soundRe;
	  	var row_lvl_1_snd3 = soundMi;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get3RandomShapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,'Ldo','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_1_',row_lvl_1_snd1,row_lvl_1_snd2,row_lvl_1_snd3,questionSound,soundLdo2,soundLdo3);
...
//--------------ROW ROW ROW LEVEL 2 --------
	 //--- RANDOM SOUNDS
	  	...
	  	var row_lvl_2_snd2 = soundRe;
	  	var row_lvl_2_snd3 = soundMi;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get3RandomShapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,'Ldo','re');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_2_',row_lvl_2_snd1,row_lvl_2_snd2,row_lvl_2_snd3,questionSound,soundLdo2,soundRe2);
...
//--------------ROW ROW ROW LEVEL 3 --------
	//--- RANDOM SOUNDS
	  	var ransound = get3RandomSounds(soundLdo,soundRe,soundMi);
	  	var row_lvl_3_snd1 = soundLdo;
	  	var row_lvl_3_snd2 = soundRe;
	    ...
	    get3RandomShapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,'mi','mi');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_3_',row_lvl_3_snd1,row_lvl_3_snd2,row_lvl_3_snd3,questionSound,soundMi2,soundMi3);
...
//--------------ROW ROW ROW LEVEL 4 --------
	//--- RANDOM SOUNDS
	  	var ransound = get3RandomSounds(soundLdo,soundRe,soundMi);
	  	var row_lvl_4_snd1 = soundRe;
	  	var row_lvl_4_snd2 = soundLdo;
	    ...
	    get3RandomShapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,'re','mi');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_4_',row_lvl_4_snd1,row_lvl_4_snd2,row_lvl_4_snd3,questionSound,soundRe2,soundMi2);
...
//--------------ROW ROW ROW LEVEL 5 --------
	//--- RANDOM SOUNDS
	  	...
	  	var row_lvl_5_snd1 = soundFa;
	  	var row_lvl_5_snd2 = soundSol;
	  	var row_lvl_5_snd3 = soundMi;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get3RandomShapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,'fa','sol');

	    //-- END RANDOM SHAPES
		
		startGame3Shapes('row_lvl_5_',row_lvl_5_snd1,row_lvl_5_snd2,row_lvl_5_snd3,questionSound,soundFa2,soundSol2);
...
//--------------ROW ROW ROW LEVEL 6 --------
	//--- RANDOM SOUNDS
	  	...
	  	var row_lvl_6_snd2 = soundLa;
	  	var row_lvl_6_snd3 = soundMi;
	  	var row_lvl_6_snd4 = soundSi;
	  	var row_lvl_6_snd5 = soundHdo;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get5RandomShapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,'Hdo','Hdo','Hdo');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_6_',row_lvl_6_snd1,row_lvl_6_snd2,row_lvl_6_snd3,row_lvl_6_snd4,row_lvl_6_snd5,questionSound,soundHdo,soundHdo,soundHdo);
...
//--------------ROW ROW ROW LEVEL 7 --------
	//--- RANDOM SOUNDS
	    ...
	    get5RandomShapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,'sol','sol','sol');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_7_',row_lvl_7_snd1,row_lvl_7_snd2,row_lvl_7_snd3,row_lvl_7_snd4,row_lvl_7_snd5,questionSound,soundSol,soundSol,soundSol);
...
//--------------ROW ROW ROW LEVEL 8 --------
	//--- RANDOM SOUNDS
	  	...
	  	var row_lvl_8_snd1 = soundRe;
	  	var row_lvl_8_snd2 = soundFa;
	  	var row_lvl_8_snd3 = soundLdo;
	  	var row_lvl_8_snd4 = soundSi;
	    ...
	    get5RandomShapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,'mi','mi','mi');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_8_',row_lvl_8_snd1,row_lvl_8_snd2,row_lvl_8_snd3,row_lvl_8_snd4,row_lvl_8_snd5,questionSound,soundMi,soundMi,soundMi);
...
//--------------ROW ROW ROW LEVEL 9 --------
	//--- RANDOM SOUNDS
	  	...
	  	var row_lvl_9_snd4 = soundSi;
	  	var row_lvl_9_snd5 = soundHdo;

	    //--= END RANDOM SOUNDS

	    	    //--RANDOM SHAPES

	    get5RandomShapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,'Ldo','Ldo','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame5Shapes('row_lvl_9_',row_lvl_9_snd1,row_lvl_9_snd2,row_lvl_9_snd3,row_lvl_9_snd4,row_lvl_9_snd5,questionSound,soundLdo,soundLdo,soundLdo);
...
//--------------ROW ROW ROW LEVEL 10 --------
	//--- RANDOM SOUNDS
	    ...
	    get8RandomShapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
	    	row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,'sol','fa','mi','re','Ldo');

	    //-- END RANDOM SHAPES
		
		startGame8Shapes('row_lvl_10_',row_lvl_10_snd1,row_lvl_10_snd2,row_lvl_10_snd3,row_lvl_10_snd4,row_lvl_10_snd5,
			row_lvl_10_snd6,row_lvl_10_snd7,row_lvl_10_snd8,questionSound,soundSol3,soundFa3,soundMi3,soundRe3,soundLdo3);
...
//-- ANIMATE ANSWERS --
 function checkAnswerTut()
 {
 			var yehey = document.createElement('audio');
			yehey.setAttribute('src' , 'audio/cheer.mp3');
		
			$('#tut_row_ans1').effect('shake','slow').promise(soundLdo3.play()).done(function()
			{	
						

				$('#tut_row_ans2').effect('shake','slow').promise(soundRe3.play()).done(function()
				{													
						...
						yehey.play();
						ready = false;
						$('#tut_row_lvl_1_animate').removeClass("locked");
						$('#tut_row_lvl_1_check').addClass("locked");

						$('#tut_row_ans1').css('background-image', 'url("question_img.png")');
						$('#tut_row_ans2').css('background-image', 'url("question_img.png")');

						$('#tut_row_ans2').removeClass('zindex-5000-red');
						$('#tut_row_ans2').removeClass('zindex-5000-red');
						$('#tut_row_lvl_1_s2').removeClass('zindex-5000');
						$('#tut_row_lvl_1_check').removeClass('zindex-5000');

						$('#tut_row_lvl_1_s1').addClass('zindex-5000');
			...
			{	
				...
				{													
					...
					if ( $('#'+$level+'1').text() == $soundPattern1 && $('#'+$level+'2').text() == $soundPattern2) 
					{
						...
						if (level_check >= nl)
						{
							window.localStorage.setItem("row_current_level",++nl);
						}
					...
					$('#'+$level+'ans3').effect('shake','slow').promise(thirdSound.play()).done(function()
					{
						...
						{													
							...
							{		
										...
										answerArray[1].currentTime = 0;
										answerArray[2].currentTime = 0;
										answerArray[3].currentTime = 0;
										answerArray[4].currentTime = 0;
...
{
	var retries = window.localStorage.getItem("num_ret");
	...
	window.localStorage.setItem("num_ret",++retries);

	//alert("Retries = " + window.localStorage.getItem("num_ret") );
...
function tutInit()
{
	...
	$('.current-step-mes').text('Tap the Diamond');
	$('.grayscreen').show();
	itslevel1 = true;
	$('#category').hide();
}
...
function stepNumber()
{
	...
	if (stepnum == 1)
	{
		$('#tut_row_lvl_1_s1').removeClass('zindex-5000');
		$('#tut_row_lvl_1_s2').addClass('zindex-5000');
		$('.current-step-mes').text('Tap the Circle');
		stepnum++;
	}
	else if (stepnum == 2 ) 
	{
		$('#tut_row_lvl_1_s2').removeClass('zindex-5000');
		$('#tut_row_lvl_1_s3').addClass('zindex-5000');
		$('.current-step-mes').text('Tap the Heart');
		stepnum++;
	}
	else if (stepnum == 3) 
	{
		$('#tut_row_lvl_1_s3').removeClass('zindex-5000');
		$('#tut_row_lvl_1_animate').addClass('zindex-5000');
		$('.current-step-mes').text('Tap Play to start the test');
		stepnum++;
	}
	else if (stepnum == 4) 
	{
		$('#tut_row_lvl_1_animate').removeClass('zindex-5000');
		$('.current-step-mes').text('Listen Carefully');
		stepnum++;
	}
	else if (stepnum == 5) 
	{
		$('#tut_row_lvl_1_s1').removeClass('zindex-5000');
		$('#tut_row_ans1').addClass('zindex-5000-red');
		$('#tut_row_lvl_1_s2').addClass('zindex-5000');
		$('.current-step-mes').text('Tap the Circle');
	...
	else if (stepnum == 6) 
	{
		...
		$('.current-step-mes').text('Tap Check and see if it is correct');
		$('#tut_row_ans2').addClass('zindex-5000-red');
		$('#tut_row_lvl_1_s2').removeClass('zindex-5000');
		$('#tut_row_lvl_1_check').addClass('zindex-5000');
		stepnum++;
	...
	{
		console.log("pumasok dito step num 7");
	}
}
